...
# Important variables
mol2file = sys.argv[1]
observables = ["Stereocenters", "cLogP", "ESOL", "QED", "SA_Score", "Failed_clogp", "Failed_logS", "Failed_QED", "Failed_SA", "Failed_stereo"]#, "Layer_Completed"]
...
for elem in all_txt:
    ...
    if observable in ["Failed_clogp", "Failed_logS", "Failed_QED", "Failed_SA", "Failed_stereo"]:
