...
# Important variables
mol2file = sys.argv[1]
observables = ["RD_Stereocenters", "RD_LogP", "RD_TPSA", "RD_SYNTHA", "RD_QED", 
               "Failed_LogP", "Failed_TPSA", "Failed_SYNTHA", "Failed_QED", "Failed_stereo"]#, "Layer_Completed"]
...
for elem in all_txt:
    ...
    if observable in ["Failed_LogP", "Failed_QED", "Failed_SYNTHA", "Failed_stereo", "Failed_TPSA"]:
...
# ======================
#        '''
#    elif observable in ["cLogP", "ESOL", "QED", "SA_Score"]:
